...
img_hero = 'roket.png'
img_enemy = 'fich.png'
img_bullet = 'kabum.png'
img_ast = '1346944555.png'
score = 0
lost = 0
max_lost = 10
goal = 20
...
for i in range(1,6):
    monster = Enemy(img_enemy, randint(80, win_height - 80), -40, 80, 50, randint(5,10))
    ...
    if not finish:
        ...
        if rel_time == True:
            ...
            if now_time - last_time < 3:
                reload = font2.render('recargando...............')
